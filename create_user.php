...
<html lang="en">
	...
	<head>
		...
		<script type="application/x-javascript">
			...
			$.ajax({
				type: "POST",
				url: "create_user_result.php",
				data: {first_name:fname, last_name:lname,email_id:email,password:pwd,access_role:role,department:team}
				...
				<div class="col-sm-4"></div>
					<div class="col-sm-4" style="background-color:white; padding: 30px; box-shadow:0px 0px 0px 4px #B0B0B0 ;">
							...
							<div class="form-group ">
								<input type="text" placeholder="Enter First Name" name="fname" id="fname" required class="form-control" style="box-shadow: 0px 0px 0px 4px #f2f5f7;">
							 </div>
							 <div class="form-group ">
								<input type="text" placeholder="Enter Last Name" name="lname" id="lname" required class="form-control" style="box-shadow: 0px 0px 0px 4px #f2f5f7;">
							 </div>
							  <div class="form-group ">
								<input type="text" placeholder="Enter e-mail (name@microfocus.com)" name="email" id="email" required class="form-control" style="box-shadow: 0px 0px 0px 4px #f2f5f7;">
							 </div>
							 <div class="form-group ">
								<input type="password" placeholder="Enter Password" name="pwd" id="pwd" required class="form-control" style="box-shadow: 0px 0px 0px 4px #f2f5f7;">
							 </div>
							 <div class="form-group ">
								 <?php
									$username = "root";
							...
							<p>
							<button type="submit" id="create_user" class="btn btn-primary" onclick="changeFunc();" style="float:right;">Create</button>
							</p>
