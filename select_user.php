...
<html lang="en">
	...
	<?php
		...
		$result = mysql_query("SELECT first_name from user_details");
				...
				<div class="col-sm-4"></div>
					<div class="col-sm-4" style="background-color:white; padding: 30px; box-shadow:0px 0px 0px 4px #B0B0B0 ;">
						<form action="modify_user.php" method="POST">
							<center style="background: url(img/bg_form.jpg) #10a5d3; color: #555555"><label>Select User to Modify</label></center>
							<br>
							 <div class="form-group ">
								<label for="User">Users: </label>&nbsp;&nbsp;<select id="user" name="user">
									<?php
