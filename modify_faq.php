...
<html lang="en">
	...
	<head>
		...
		<script type="application/x-javascript">
			...
			var id = document.getElementById("faq_id").value;
			...
			$.ajax({
				type: "POST",
				url: "modify_faq_result.php",
				data: {faq_title:title,faq_desc:description,faq_id:id}
...
<div style="margin-top:30px;">
	<div id="wrapper" class="container-fluid" style="width:65%; margin:0 auto 0;">
		<div class="row">
			<div class="col-sm-2"></div>
				<div class="col-sm-8">
					<input type="text" name="search" id="search" placeholder="Search for FAQs to Update">
	...
	<div id="wrapper1" class="container-fluid" style="width:65%; margin:0 auto 0;">	</div>
</body>